...
listings.to_csv('/home/jishnu/Documents/ISB/Term3/practicum/workspace/data_collection/data/daily_data/listings_{0}.csv'.format(str(now.strftime("%Y%m%d"))))
ticker_df.to_csv('/home/jishnu/Documents/ISB/Term3/practicum/workspace/data_collection/data/daily_data/ticker_data_{0}.csv'.format(str(now.strftime("%Y%m%d"))))
global_data.to_csv('/home/jishnu/Documents/ISB/Term3/practicum/workspace/data_collection/data/daily_data/global_data_{0}.csv'.format(str(now.strftime("%Y%m%d"))))
